  ...
  return (
    <div style={{ background: '#000', minHeight: '100vh', paddingBottom: 40 }}>
      ...
      <div style={{ position: 'sticky', top: 0, zIndex: 20, background: 'rgba(0,0,0,0.85)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', borderBottom: '0.5px solid rgba(255,255,255,0.08)', padding: '52px 16px 12px', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <button type="button" onClick={() => router.back()} style={{ display: 'flex', alignItems: 'center', gap: 4, color: '#22c55e', fontSize: 17, background: 'none', padding: 0 }}>
      ...
      <div style={{ padding: '20px 16px 0' }}>
        ...
        <button
          ...
          style={{ width: '100%', background: 'linear-gradient(135deg, #1a3a1a, #22c55e22)', border: '1px solid rgba(34,197,94,0.3)', borderRadius: 14, padding: '14px 0', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 16, cursor: 'pointer' }}
        >
